    ...
    <main className="bg-background min-h-screen font-sans text-gray">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-4 h-full">
          <h1 className="text-white text-center text-3xl md:text-5xl font-extrabold leading-tight mb-4 max-w-[35ch]">
            Building More Than Homes. Creating Lasting Value.
          </h1>
          <p className="text-white text-center text-lg md:text-2xl max-w-2xl">
            ...
            enrich lives and drive long-term growth — for families, communities,
            and investors alike.
          </p>
        </div>
      </section>
