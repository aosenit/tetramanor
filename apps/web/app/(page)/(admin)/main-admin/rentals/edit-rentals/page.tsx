...
// 				images: rentalData?.data?.images || [],
// 				isFurnished: rentalData?.data?.isFurnished || false,
// 				availableUnits: rentalData?.data?.availableUnits || 0,
// 				currency: rentalData?.data?.currency || "NGN",
// 			});
...
// 								className="bg-[#E5E5E7] border border-[#116114] rounded px-2 py-2 text-sm"
// 								required
// 							>
...
// 						options={statusOptions}
// 						value={
// 							formData.status === "NOT_RENTED" ? "Available"
// 							: formData.status === "RENTED" ?
// 								"Not Available"
// 							:	""
// 						}
