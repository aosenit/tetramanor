        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 text-sm">
              Stay on top of repairs with a clear history of all requests.
            </p>
          </div>
              ...
              {maintenanceRequests.map((request, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`text-sm font-medium ${request.status === "Completed" ? "completed" : "in-progress"}`}
                    >
                      {request.status}
                    </span>
                  </td>
