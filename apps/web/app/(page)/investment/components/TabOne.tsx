...
import guaranteed from "../../../../public/blog/guaranteed.png"
...
const steps = [
  ...
  },
  {
    ...
    description: 'Partner receives the agreed return, regardless of profit fluctuations.',
  },
];
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="">
                        ...
                        <p className="text-[#0B0A0A] text-sm">
                          This model targets smaller projects that can be completed within 18 months, offering predictable
