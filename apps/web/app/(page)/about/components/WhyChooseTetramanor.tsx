      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16 py-12">
        <div className="space-y-2 text-center max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-gray-700 text-sm">
            With over 12 years of excellence, a combined team experience of 80+
            years, and over ₦11 billion in sales, Tetramanor stands as a trusted
            leader in Nigeria's real estate market. Our commitment to quality,
